            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-5 col-lg-7 col-md-9">
                    <div class="authWrap">
                        ...
                        <div class="authhead">
                            <!-- Logo -->
                            <div class="text-center mb-4"><a href="index.html"><img class="img-fluid"
                        ...
                        <div class="authbody d-black mb-4">
                            <div class="card rounded-4 p-sm-5 p-4">
                                <div class="card-body p-0">
                                    ...
                                    <!-- Form START -->
                                    <form class="mt-5 text-start" action="{{route('login')}}" method="post">
                                        @csrf
                                        <div class="form">
                                            ...
                                            <div
                                                ...
                                                <div class="modal-flex-first">
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label" for="savepassword">Remember
                                                            Me</label>
                                                    </div>
                                                </div>
